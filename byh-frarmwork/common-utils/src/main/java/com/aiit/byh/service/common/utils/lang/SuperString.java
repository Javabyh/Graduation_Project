...
public class SuperString {
    ...
    public static String getSpeShortString(String s, int len, String fillstr) {
        ...
        for(int i = 0; i < s.length(); i++) {
            ch = s.charAt(i);
            if(((int) ch > 31) && ((int) ch < 128)) {   //允许空格：32
                reallen++;
            } else {
                reallen += 2;
            }
     ...
     * @return
     */
    public static String toYuanFromLi(String str){
    	double result = getDouble(str);
    	if(result == 0){
    		return "0.0";
    	}
    	result = result/1000.0d;
     ...
     * @return
     */
    public static String toYuanFromFen(String str){
    	double result = getDouble(str);
    	if(result == 0){
    		return "0.0";
    	}
    ...
    public static String toYuanFromFen(double result){
    	if(result == 0){
    		return "0.0";
    	}
    	result = result/100.0d;
    ...
    public static double fentoYuan(double result){
    	if(result == 0){
    		return 0;
    	}
    	result = result/100.0d;
    ...
    public static String replaceTemplateTag(String text, @SuppressWarnings("rawtypes") Map map) {
...
//	       html = html.replace("  ", "  ");
	    ...
	    * @return
	    */
	   public static boolean isListEmpty(List<String> lists) {
		   return (lists == null) || lists.isEmpty();
	   }
    
    public static void main(String[] args) {
        //System.out.println(match("(13[0-9]{9}[,]{0,1}){1,5}[#].*",
        //        "13917504705,13917504705,13917504705,13917504705,13917504705,13917504705#testjson"));
        ...
        */
    	...
    	System.out.println(SuperString.isListEmpty(lists));
    }
